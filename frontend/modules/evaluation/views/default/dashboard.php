          ...
          <div class="small-box bg-light-blue-gradient">
            <div class="inner">
              ...
              <?php 
                    ...
                    $data = [0 => 'Detractors', 1 => 'Passive', 2 => 'Promoters'];
                
                    echo $form->field($model, 'nps')->radioButtonGroup($data, [
                        'class' => 'btn-group-sm',
      ...
      <div class="row">
        ...
        <section class="col-lg-8 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Trends</li>
            </ul>
          ...
          <div class="box box-success">
            <div class="box-header">
              ...
              <h3 class="box-title">Top Comments</h3>
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <div class="box box-solid bg-teal">
            ...
            <div class="box-body">
              <div id="world-map" style="height: 250px; width: 100%;">distribution of respondents by business unit</div>
            </div>
            <!-- /.box-body-->
